...
<div class="login-system">
    ...
    <div class="login-inputs">
        <form action="reset_password2.php" method="post">
            ...
            <label for="lname">Jelszó mégegyszer</label>
            <input type="password" id="password2" name="password2" placeholder="Jelszó mégegyszer..">
            ...
            {
                echo "<div class='error1'><a>Két jelszó nem egyezik!</a></div>";
            }
            ?>

            <input type="submit" value="Megváltoztatás" id="sb-change" name="sb-change">
        </form>
    </div>
</div>
</body>
